...
void Mea_Input(int mode)
{
	...
	InputAC = (comp[900]-comp[100])*3300/65536;
	if(mode == 1)
...
{
	for (u16 temp = 0; temp< 2000;temp++)
	{
		comp[temp] = adc3_data[temp];
	}

	QuickSort(comp,0,1999);

	InputAC = (comp[1700]-comp[300])*3300/65536;
}
...
float Mea_Scan_Low(void)
{
		...
		QuickSort(comp,0,999);
		OutputAC = (comp[800]-comp[200])*3300/65536;
...
{
	u16 findtmp = 0;
	float biggest = scan_data[100]/1.314;
